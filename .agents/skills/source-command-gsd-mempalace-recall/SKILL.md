---
name: "source-command-gsd-mempalace-recall"
description: "Recall decisions, patterns, and surprises from MemPalace before planning"
---

# source-command-gsd-mempalace-recall

Use this skill when the user asks to run the migrated source command `gsd-mempalace-recall`.
