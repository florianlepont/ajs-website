...
| 004 | thumbnail-grid-poster-treatment | How should the Poster Grid energy extend to the shared GalleryGrid.astro thumbnail grid (Portfolio + Éditions detail pages)? | — | [layout, gallery, editions, thumbnail-grid, consistency] |
