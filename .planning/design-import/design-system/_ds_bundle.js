/* @ds-bundle: {"format":4,"namespace":"AtelierJacquelineSuzanneDesignSystem_04051c","components":[{"name":"EmptyState","sourcePath":"components/feedback/EmptyState.jsx"},{"name":"Button","sourcePath":"components/forms/Button.jsx"},{"name":"Input","sourcePath":"components/forms/Input.jsx"},{"name":"Textarea","sourcePath":"components/forms/Textarea.jsx"},{"name":"GalleryCard","sourcePath":"components/gallery/GalleryCard.jsx"},{"name":"Lightbox","sourcePath":"components/gallery/Lightbox.jsx"},{"name":"Footer","sourcePath":"components/navigation/Footer.jsx"},{"name":"Header","sourcePath":"components/navigation/Header.jsx"},{"name":"LanguageSwitcher","sourcePath":"components/navigation/LanguageSwitcher.jsx"}],"sourceHashes":{"components/feedback/EmptyState.jsx":"d482efbf57f1","components/forms/Button.jsx":"17d570fb3559","components/forms/Input.jsx":"368b8fb9aacd","components/forms/Textarea.jsx":"ff9145f24403","components/gallery/GalleryCard.jsx":"cd029940a0cb","components/gallery/Lightbox.jsx":"9f34c524d7e8","components/navigation/Footer.jsx":"8b07aa8c6d57","components/navigation/Header.jsx":"c2d3c1ed1271","components/navigation/LanguageSwitcher.jsx":"454e7b9cb4c9","ui_kits/website/image-slot.js":"75a3469a73c0"},"inlinedExternals":[],"unexposedExports":[]} */

(() => {

const __ds_ns = (window.AtelierJacquelineSuzanneDesignSystem_04051c = window.AtelierJacquelineSuzanneDesignSystem_04051c || {});
...
try { (() => {
function EmptyState({
  heading = "Galeries à venir",
  body = "De nouvelles œuvres seront bientôt visibles ici. Revenez prochainement."
}) {
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/gallery/GalleryCard.jsx", error: String((e && e.message) || e) }); }
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/gallery/Lightbox.jsx", error: String((e && e.message) || e) }); }

// components/navigation/Footer.jsx
try { (() => {
function Footer({
  text = "© 2026 Atelier Jacqueline Suzanne"
}) {
...
function Header({
  ...
  return /*#__PURE__*/React.createElement("header", {
    style: {
      background: transparent ? "linear-gradient(to bottom, rgba(0,0,0,0.55) 0%, rgba(0,0,0,0.25) 60%, rgba(0,0,0,0) 100%)" : "var(--color-secondary)",
  ...
  }, siteTitle)), /*#__PURE__*/React.createElement("nav", {
    style: {
      display: "flex",
      alignItems: "center",
      gap: "var(--space-lg)"
    ...
    href: "#",
    style: linkStyle
  }, homeLabel), /*#__PURE__*/React.createElement("a", {
    href: "#",
    style: linkStyle
  }, navLabel), switcher));
}
