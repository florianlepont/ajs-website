...
- [x] 05-03-PLAN.md — manual-only `deploy-ovh.yml` production workflow with recap + environment approval gate (wave 2, D-01/D-02)
- [x] 05-04-PLAN.md — `launch-smoke-check.sh` rehearsed against staging, plus the DNS cutover runbook (wave 2)

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 05-05-PLAN.md — zone capture, human go-ahead, first production SFTP push, A-record cutover (wave 3, D-02/D-04, not autonomous)

**Wave 4** *(blocked on Wave 3 completion)*

- [x] 05-06-PLAN.md — post-cutover verification: smoke check + MX diff, real mail delivery, launch evidence log (wave 4)
