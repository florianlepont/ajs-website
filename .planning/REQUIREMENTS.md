...
- [ ] **HOME-13**: Visitor sees a mobile nav menu (hamburger or similar) on the homepage instead of the desktop header bar, with the language switcher inside it, on phone-width viewports only
...
- [ ] **HOME-16**: Visitor on a phone sees a different accent color each visit, randomly picked from the existing per-gallery `heroColor` values
...
- Mapped to phases: 0/9 — pending roadmap creation
...
*Last updated: 2026-08-03 — initial v1.6 definition, awaiting roadmap creation.*
