...
- [ ] **HOME-04**: Visitor can reach Romane's Instagram via an icon link (not text) in the header nav
- [ ] **HOME-05**: The carousel/grid toggle button has a square (not rectangular) border
