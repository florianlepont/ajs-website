...
---
*Last updated: 2026-08-13 after v1.7 Launch & Domain Cutover milestone close. 1/1 requirement delivered (LAUNCH-01) — the site is now live at atelierjacquelinesuzanne.fr, fully replacing the old Myportfolio site. This closes the last requirement deliberately deferred since v1.0's close on 2026-07-27. All roadmapped work (v1.0 through v1.7) is now shipped. Next: `/gsd-new-milestone` to scope the v1.x wave (Exhibitions, Shop, Checkout, Shipping, commerce Legal).*
