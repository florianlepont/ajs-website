...
<required_reading>
@/home/user/ajs-website/.claude/gsd-core/references/common-bug-patterns.md
</required_reading>
...
@/home/user/ajs-website/.claude/gsd-core/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/user/ajs-website/.claude
                  → checks /home/user/ajs-website/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/user/ajs-website/.claude/gsd-core
                  → writes to /home/user/ajs-website/.claude/gsd-core/hooks/
...
@/home/user/ajs-website/.claude/gsd-core/references/thinking-models-debug.md
...
- Read @/home/user/ajs-website/.claude/gsd-core/references/common-bug-patterns.md
