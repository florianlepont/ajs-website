...
```markdown
Read /home/user/ajs-website/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/user/ajs-website/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/user/ajs-website/.claude/agents/gsd-ui-checker.md for instructions.
