...
```
Agent(
  prompt="Read /home/user/ajs-website/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/ajs-website/.claude/gsd-core/templates/SECURITY.md`
